...
function withdrawToken(address _token, uint256 _amount) public {
  //Ensure user has enough tokens to withdraws
...
function makeOrder(
  ...
  // Create order
  orderCount++; // same as orderCount = orderCount + 1;
  ...
  function cancelOrder(uint256 _id) public {
    ...
    // Ensure the callet of the function is the owner of the order
